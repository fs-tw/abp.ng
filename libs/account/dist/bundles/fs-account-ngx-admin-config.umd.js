(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@fs/account/ngx-admin/config', ['exports', '@abp/ng.core', '@angular/core', '@angular/router', '@abp/ng.theme.shared'], factory) :
    (global = global || self, factory((global.fs = global.fs || {}, global.fs.account = global.fs.account || {}, global.fs.account['ngx-admin'] = global.fs.account['ngx-admin'] || {}, global.fs.account['ngx-admin'].config = {}), global.ng_core, global.ng.core, global.ng.router, global.ng_theme_shared));
...
//# sourceMappingURL=fs-account-ngx-admin-config.umd.js.map
