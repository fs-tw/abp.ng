...
export class EmailSettingsComponent implements OnInit {
  public static POLICY_NAMES = {
    EmailSettings: '',
  };

  public static TAB_NAMES = {
    EmailSettings: 'AbpSettingManagement::Menu:Emailing',
  };
  form!: UntypedFormGroup;
  emailTestForm!: UntypedFormGroup;
  saving = false;
  emailingPolicy = eEmailSettingsPolicyNames.EmailSettings;
