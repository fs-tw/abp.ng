...
export declare type EntityPropOptions<R = any> = O.Optional<O.Writable<EntityProp<R>>, 'permission' | 'visible' | 'displayName' | 'isExtra' | 'columnWidth' | 'sortable' | 'valueResolver'>;
