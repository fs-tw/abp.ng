...
export declare type Modules = Configuration<Module>;
export interface Module {
    configuration: Configuration;
    entities: Entities;
}
export declare type Entities = Configuration<Entity>;
export interface Entity {
    configuration: Configuration;
    properties: Properties;
}
export declare type Properties = Configuration<Property>;
...
export declare type Configuration<T = any> = Record<string, T>;
