(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@abp/ng.core'), require('@angular/core'), require('primeng/components/common/messageservice'), require('primeng/toast'), require('rxjs'), require('@angular/router'), require('@ngxs/store'), require('rxjs/operators'), require('@ngx-validate/core'), require('@angular/animations'), require('@angular/common/http'), require('snq')) :
    typeof define === 'function' && define.amd ? define('@abp/ng.theme.shared', ['exports', '@abp/ng.core', '@angular/core', 'primeng/components/common/messageservice', 'primeng/toast', 'rxjs', '@angular/router', '@ngxs/store', 'rxjs/operators', '@ngx-validate/core', '@angular/animations', '@angular/common/http', 'snq'], factory) :
    (global = global || self, factory((global.abp = global.abp || {}, global.abp.ng = global.abp.ng || {}, global.abp.ng.theme = global.abp.ng.theme || {}, global.abp.ng.theme.shared = {}), global.ng_core, global.ng.core, global.messageservice, global.toast, global.rxjs, global.ng.router, global.store, global.rxjs.operators, global.core$1, global.ng.animations, global.ng.common.http, global.snq));
}(this, function (exports, ng_core, core, messageservice, toast, rxjs, router, store, operators, core$1, animations, http, snq) { 'use strict';
