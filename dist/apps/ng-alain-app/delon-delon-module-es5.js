        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CacheService = /** @class */ (function () {
                ...
                CacheService.prototype.set = function (key, data, options) {
                    ...
                    /** @type {?} */
                    var e = 0;
                    var _b = this.cog, type = _b.type, expire = _b.expire;
                ...
                CacheService.prototype.get = function (key, options) {
                    ...
                    if (!value || (value.e && value.e > 0 && value.e < new Date().valueOf())) {
                        if (isPromise) {
                             ...
                             * @param {?} ret
                             * @return {?}
                             */function (ret) { return _this.deepGet(ret, ( /** @type {?} */(_this.cog.reName)), null); })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(( /**
                             * @param {?} v
                             * @return {?}
                             */function (/**
                             * @param {?} v
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PrintComponent = /** @class */ (function () {
                function PrintComponent(lodopSrv, msg, notify) {
                    ...
                    this.papers = [];
                    this.printing = false;
                    this.lodopSrv.lodop.subscribe(function (_b) {
                        var lodop = _b.lodop, ok = _b.ok;
                        if (!ok) {
                            _this.error = true;
                            return;
                        }
