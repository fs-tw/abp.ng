...
/* harmony import */ var _abp_ng_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @abp/ng.core */ "../../packages/core/src/public-api.ts");
...
let SettingManagementComponent = class SettingManagementComponent {
    ...
    get selected() {
        const value = this.store.selectSnapshot(_states_setting_management_state__WEBPACK_IMPORTED_MODULE_6__["SettingManagementState"].getSelectedTab);
    ...
    ngOnInit() {
        this.settings = Object(_abp_ng_theme_shared__WEBPACK_IMPORTED_MODULE_2__["getSettingTabs"])()
            .filter(setting => this.store.selectSnapshot(_abp_ng_core__WEBPACK_IMPORTED_MODULE_5__["ConfigState"].getGrantedPolicy(setting.requiredPolicy)))
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "../../node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _components_setting_management_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/setting-management.component */ "../../packages/setting-management/src/lib/components/setting-management.component.ts");
