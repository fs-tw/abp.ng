        ...
        value: function onSubmit() {
          ...
          this.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_1__["ChangePassword"]({
            ...
            error: function error(err) {
              _this.toasterService.error(Object(snq__WEBPACK_IMPORTED_MODULE_7__["default"])(function () {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit() {
          ...
          Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["from"])(this.oauthService.fetchTokenUsingPasswordFlow(this.form.get('username').value, this.form.get('password').value, new _angular_common_http__WEBPACK_IMPORTED_MODULE_11__["HttpHeaders"](Object.assign({}, tenant && tenant.id && {
            ...
            return _this2.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_1__["GetAppConfiguration"]());
            ...
            }).redirectUrl || (_this2.options || {}).redirectUrl || '/';

            _this2.store.dispatch(new _ngxs_router_plugin__WEBPACK_IMPORTED_MODULE_4__["Navigate"]([redirectUrl]));
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["catchError"])(function (err) {
            _this2.toasterService.error(Object(snq__WEBPACK_IMPORTED_MODULE_10__["default"])(function () {
            ...
            return _this2.inProgress = false;
          })).subscribe();
        }
      }]);
      ...
      _createClass(PersonalSettingsComponent, [{
        ...
        value: function submit() {
          ...
          this.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_1__["UpdateProfile"](this.form.value)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () {
            ...
            _this4.toasterService.success('AbpAccount::PersonalSettingsSaved', 'Success', {
              life: 5000
            });
          });
        }
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.accountService.register(newUser).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["switchMap"])(function () {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["from"])(_this5.oauthService.fetchTokenUsingPasswordFlow(newUser.userName, newUser.password, new _angular_common_http__WEBPACK_IMPORTED_MODULE_13__["HttpHeaders"](Object.assign({}, tenant && tenant.id && {
              __tenant: tenant.id
            }))));
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["switchMap"])(function () {
            return _this5.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_1__["GetAppConfiguration"]());
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["tap"])(function () {
            return _this5.store.dispatch(new _ngxs_router_plugin__WEBPACK_IMPORTED_MODULE_5__["Navigate"](['/']));
            ...
            _this5.toasterService.error(Object(snq__WEBPACK_IMPORTED_MODULE_10__["default"])(function () {
              return err.error.error_description;
            }) || Object(snq__WEBPACK_IMPORTED_MODULE_10__["default"])(function () {
              return err.error.error.message;
            }, 'AbpAccount::DefaultErrorMessage'), 'Error', {
            ...
            return _this5.inProgress = false;
          })).subscribe();
        }
      }]);
        ...
        value: function save() {
          ...
          if (this.tenant.name && !this.inProgress) {
            ...
            this.accountService.findTenant(this.tenant.name).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () {
              ...
              _this6.toasterService.error(Object(snq__WEBPACK_IMPORTED_MODULE_7__["default"])(function () {
                return err.error.error_description;
              ...
              if (success) {
                _this6.tenant = {
                  id: tenantId,
                  name: _this6.tenant.name
                };
                _this6.tenantName = _this6.tenant.name;
                _this6.isModalVisible = false;
              } else {
                _this6.toasterService.error('AbpUiMultiTenancy::GivenTenantIsNotAvailable', 'AbpUi::Error', {
                  messageLocalizationParams: [_this6.tenant.name]
                });

                _this6.tenant = {};
              }

              _this6.store.dispatch(new _abp_ng_core__WEBPACK_IMPORTED_MODULE_1__["SetTenant"](success ? _this6.tenant : null));
            });
          } else {
