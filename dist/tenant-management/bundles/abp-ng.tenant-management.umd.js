(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@abp/ng.tenant-management', ['exports', '@abp/ng.core', '@abp/ng.theme.shared', '@angular/core', '@ng-bootstrap/ng-bootstrap', '@ngxs/store', '@angular/forms', 'rxjs', 'rxjs/operators', '@angular/router', '@abp/ng.feature-management', '@ngx-validate/core'], factory) :
    (global = global || self, factory((global.abp = global.abp || {}, global.abp.ng = global.abp.ng || {}, global.abp.ng['tenant-management'] = {}), global.ng_core, global.ng_theme_shared, global.ng.core, global.ngBootstrap, global.store, global.ng.forms, global.rxjs, global.rxjs.operators, global.ng.router, global.ng_featureManagement, global.core$1));
}(this, (function (exports, ng_core, ng_theme_shared, core, ngBootstrap, store, forms, rxjs, operators, router, ng_featureManagement, core$1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TenantManagementState = /** @class */ (function () {
        ...
        function (_a, _b) {
            ...
            var payload = _b.payload;
            return this.tenantManagementService.updateTenant(__assign({}, getState().selectedItem, payload));
        };
    ...
    var TenantsComponent = /** @class */ (function () {
        ...
        function () {
            ...
            var tenantForm = this.fb.group({
                ...
                adminPassword: [null, [forms.Validators.required]],
            });
