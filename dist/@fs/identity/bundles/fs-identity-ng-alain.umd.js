(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fs/identity'), require('@abp/ng.core'), require('@angular/core'), require('@fs/ng-alain/basic'), require('@angular/router'), require('@abp/ng.identity/components/users/users.component'), require('@abp/ng.theme.shared'), require('@angular/forms'), require('@ngxs/store'), require('@abp/ng.identity/components/roles/roles.component'), require('@fs/permission-management/ng-alain')) :
    typeof define === 'function' && define.amd ? define('@fs/identity/ng-alain', ['exports', '@fs/identity', '@abp/ng.core', '@angular/core', '@fs/ng-alain/basic', '@angular/router', '@abp/ng.identity/components/users/users.component', '@abp/ng.theme.shared', '@angular/forms', '@ngxs/store', '@abp/ng.identity/components/roles/roles.component', '@fs/permission-management/ng-alain'], factory) :
    (global = global || self, factory((global.fs = global.fs || {}, global.fs.identity = global.fs.identity || {}, global.fs.identity['ng-alain'] = {}), global.fs.identity, global.ng_core, global.ng.core, global.basic, global.ng.router, global.users_component, global.ng_theme_shared, global.ng.forms, global.store, global.roles_component, global.ngAlain));
}(this, (function (exports, identity, ng_core, core, basic, router, users_component, ng_theme_shared, forms, store, roles_component, ngAlain) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    }(roles_component.RolesComponent));
    if (false) {
        /**
         * @type {?}
         * @private
