(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@fs/account/ngx-admin', ['exports', '@fs/account', '@abp/ng.core', '@angular/core', '@fs/ngx-admin/basic', '@angular/router', '@abp/ng.account', '@abp/ng.theme.shared', '@angular/forms', '@ngxs/store', 'angular-oauth2-oidc', '@abp/ng.account/services/account.service', '@abp/ng.account/components/tenant-box/tenant-box.component'], factory) :
    (global = global || self, factory((global.fs = global.fs || {}, global.fs.account = global.fs.account || {}, global.fs.account['ngx-admin'] = {}), global.fs.account, global.ng_core, global.ng.core, global.basic, global.ng.router, global.ng_account, global.ng_theme_shared, global.ng.forms, global.store, global.angularOauth2Oidc, global.account_service, global.tenantBox_component));
}(this, (function (exports, account, ng_core, core, basic, router, ng_account, ng_theme_shared, forms, store, angularOauth2Oidc, account_service, tenantBox_component) { 'use strict';
