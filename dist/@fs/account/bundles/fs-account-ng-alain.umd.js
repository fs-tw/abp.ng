(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fs/account'), require('@abp/ng.core'), require('@angular/core'), require('@fs/ng-alain/basic'), require('@angular/router'), require('@abp/ng.account'), require('@abp/ng.theme.shared'), require('@angular/forms'), require('@ngxs/store'), require('angular-oauth2-oidc'), require('@abp/ng.account/services/account.service'), require('@angular/animations'), require('@abp/ng.account/components/tenant-box/tenant-box.component')) :
    typeof define === 'function' && define.amd ? define('@fs/account/ng-alain', ['exports', '@fs/account', '@abp/ng.core', '@angular/core', '@fs/ng-alain/basic', '@angular/router', '@abp/ng.account', '@abp/ng.theme.shared', '@angular/forms', '@ngxs/store', 'angular-oauth2-oidc', '@abp/ng.account/services/account.service', '@angular/animations', '@abp/ng.account/components/tenant-box/tenant-box.component'], factory) :
    (global = global || self, factory((global.fs = global.fs || {}, global.fs.account = global.fs.account || {}, global.fs.account['ng-alain'] = {}), global.fs.account, global.ng_core, global.ng.core, global.basic, global.ng.router, global.ng_account, global.ng_theme_shared, global.ng.forms, global.store, global.angularOauth2Oidc, global.account_service, global.ng.animations, global.tenantBox_component));
}(this, (function (exports, account, ng_core, core, basic, router, ng_account, ng_theme_shared, forms, store, angularOauth2Oidc, account_service, animations, tenantBox_component) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var UserRegisterComponent = /** @class */ (function (_super) {
        ...
        UserRegisterComponent.ctorParameters = function () { return [
            { type: forms.FormBuilder },
            { type: account_service.AccountService },
            { type: angularOauth2Oidc.OAuthService },
            { type: store.Store },
            { type: ng_theme_shared.ToasterService }
        ]; };
    ...
    }(tenantBox_component.TenantBoxComponent));
    if (false) {
        /** @type {?} */
