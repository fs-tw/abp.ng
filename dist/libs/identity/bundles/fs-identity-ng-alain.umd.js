(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@fs/ng-alain/basic'), require('@abp/ng.identity'), require('@abp/ng.theme.shared'), require('@angular/forms'), require('@ngxs/store'), require('@abp/ng.core'), require('@fs/permission-management/ng-alain'), require('@ngx-validate/core')) :
    typeof define === 'function' && define.amd ? define('@fs/identity/ng-alain', ['exports', '@angular/core', '@fs/ng-alain/basic', '@abp/ng.identity', '@abp/ng.theme.shared', '@angular/forms', '@ngxs/store', '@abp/ng.core', '@fs/permission-management/ng-alain', '@ngx-validate/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.fs = global.fs || {}, global.fs.identity = global.fs.identity || {}, global.fs.identity['ng-alain'] = {}), global.ng.core, global.basic, global.ng_identity, global.ng_theme_shared, global.ng.forms, global.store, global.ng_core, global.ngAlain, global.core$1));
}(this, (function (exports, core, basic, ng_identity, ng_theme_shared, forms, store, ng_core, ngAlain, core$1) { 'use strict';
