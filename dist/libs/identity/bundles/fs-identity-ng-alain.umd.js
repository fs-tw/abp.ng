(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@fs/identity/wrap'), require('@angular/core'), require('@fs/ng-alain/basic'), require('@abp/ng.identity'), require('@abp/ng.theme.shared'), require('@angular/forms'), require('@ngxs/store'), require('@abp/ng.core'), require('@fs/permission-management/ng-alain')) :
    typeof define === 'function' && define.amd ? define('@fs/identity/ng-alain', ['exports', '@fs/identity/wrap', '@angular/core', '@fs/ng-alain/basic', '@abp/ng.identity', '@abp/ng.theme.shared', '@angular/forms', '@ngxs/store', '@abp/ng.core', '@fs/permission-management/ng-alain'], factory) :
    (global = global || self, factory((global.fs = global.fs || {}, global.fs.identity = global.fs.identity || {}, global.fs.identity['ng-alain'] = {}), global.fs.identity.wrap, global.ng.core, global.basic, global.ng_identity, global.ng_theme_shared, global.ng.forms, global.store, global.ng_core, global.ngAlain));
}(this, (function (exports, wrap, core, basic, ng_identity, ng_theme_shared, forms, store, ng_core, ngAlain) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.UsersComponent = /** @class */ (function (_super) {
    ...
    exports.UsersComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ng_core.ListService,
            ...
            forms.FormBuilder,
            store.Store,
            ng_identity.IdentityService])
    ], exports.UsersComponent);

    exports.RolesComponent = /** @class */ (function (_super) {
    ...
    exports.RolesComponent = __decorate([
        core.Component({
    ...
    exports.IdentityNgAlainModule = IdentityNgAlainModule_1 = /** @class */ (function () {
        ...
        IdentityNgAlainModule.forLazy = function () {
            return new ng_core.LazyModuleFactory(IdentityNgAlainModule_1.forChild());
        };
        return IdentityNgAlainModule;
    }());
    exports.IdentityNgAlainModule = IdentityNgAlainModule_1 = __decorate([
        core.NgModule({
            declarations: [exports.UsersComponent, exports.RolesComponent],
            entryComponents: [exports.UsersComponent, exports.RolesComponent],
            imports: [
                ng_core.CoreModule,
