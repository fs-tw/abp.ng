(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@nebular/auth'), require('@nebular/security'), require('rxjs'), require('@angular/router'), require('rxjs/operators'), require('@nebular/theme'), require('@nebular/eva-icons')) :
    typeof define === 'function' && define.amd ? define('@fs/ngx-admin', ['exports', '@angular/core', '@angular/common', '@nebular/auth', '@nebular/security', 'rxjs', '@angular/router', 'rxjs/operators', '@nebular/theme', '@nebular/eva-icons'], factory) :
    (global = global || self, factory((global.fs = global.fs || {}, global.fs['ngx-admin'] = {}), global.ng.core, global.ng.common, global.auth, global.security, global.rxjs, global.ng.router, global.rxjs.operators, global.theme, global.evaIcons));
}(this, (function (exports, core, common, auth, security, rxjs, router, operators, theme, evaIcons) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var LayoutService = /** @class */ (function () {
         ...
         */
        function () {
            return this.layoutSize$.pipe(operators.share(), operators.delay(1));
        };
    ...
    }(security.NbRoleProvider));
    /** @type {?} */
    var NB_CORE_PROVIDERS = __spread(MockDataModule.forRoot().providers, DATA_SERVICES, auth.NbAuthModule.forRoot({
        strategies: [
            auth.NbDummyAuthStrategy.setup({
                name: 'email',
                delay: 3000,
            }),
        ],
        ...
        security.NbSecurityModule.forRoot({
            accessControl: {
                guest: {
                    view: '*',
                },
        ...
        {
            provide: security.NbRoleProvider, useClass: NbSimpleRoleProvider,
        },
        AnalyticsService,
        LayoutService,
        PlayerService,
    ...
    var TinyMCEComponent = /** @class */ (function () {
        function TinyMCEComponent(host, locationStrategy) {
            ...
            this.editorKeyup = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
    ...
    var ThemeModule = /** @class */ (function () {
        ...
        ThemeModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: __spread([common.CommonModule], PIPES, COMPONENTS),
    ...
    exports.CountryOrderData = CountryOrderData;
    exports.EarningData = EarningData;
    exports.ElectricityData = ElectricityData;
    ...
    exports.OrdersChartData = OrdersChartData;
    exports.OrdersProfitChartData = OrdersProfitChartData;
    exports.PlayerService = PlayerService;
    exports.PluralPipe = PluralPipe;
    exports.ProfitBarAnimationChartData = ProfitBarAnimationChartData;
    exports.ProfitChartData = ProfitChartData;
    exports.RoundPipe = RoundPipe;
    exports.SearchInputComponent = SearchInputComponent;
    exports.SecurityCamerasData = SecurityCamerasData;
    exports.SmartTableData = SmartTableData;
    exports.SolarData = SolarData;
    exports.StateService = StateService;
    exports.StatsBarData = StatsBarData;
    exports.StatsProgressBarData = StatsProgressBarData;
    exports.TemperatureHumidityData = TemperatureHumidityData;
    ...
    exports.Track = Track;
    exports.TrafficBarData = TrafficBarData;
    exports.TrafficChartData = TrafficChartData;
    exports.TrafficListData = TrafficListData;
    exports.TwoColumnsLayoutComponent = TwoColumnsLayoutComponent;
    exports.UserActivityData = UserActivityData;
    exports.UserData = UserData;
    exports.VisitorsAnalyticsData = VisitorsAnalyticsData;
    exports.ɵa = MockDataModule;
    exports.ɵb = UserService;
    exports.ɵc = ElectricityService;
    exports.ɵd = SmartTableService;
    exports.ɵe = UserActivityService;
    exports.ɵf = PeriodsService;
    exports.ɵg = OrdersChartService;
    exports.ɵh = ProfitChartService;
    exports.ɵi = TrafficListService;
    exports.ɵj = EarningService;
    exports.ɵk = OrdersProfitChartService;
    exports.ɵl = TrafficBarService;
    exports.ɵm = ProfitBarAnimationChartService;
    exports.ɵn = TemperatureHumidityService;
    exports.ɵo = SolarService;
    exports.ɵp = TrafficChartService;
    exports.ɵq = StatsBarService;
    exports.ɵr = CountryOrderService;
    exports.ɵs = StatsProgressBarService;
    exports.ɵt = VisitorsAnalyticsService;
    exports.ɵu = SecurityCamerasService;
    exports.ɵv = DEFAULT_THEME;
    exports.ɵw = COSMIC_THEME;
    exports.ɵx = CORPORATE_THEME;
    exports.ɵy = DARK_THEME;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=fs-ngx-admin.umd.js.map
