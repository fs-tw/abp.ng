...
export declare class IdentityState {
    ...
    getRoles({ patchState }: StateContext<Identity.State>, { payload }: GetRoles): import("rxjs").Observable<import("../../../../../dist/core/public-api").ABP.PagedResponse<Identity.RoleItem>>;
    ...
    getUsers({ patchState }: StateContext<Identity.State>, { payload }: GetUsers): import("rxjs").Observable<import("../../../../../dist/core/public-api").ABP.PagedResponse<Identity.UserItem>>;
